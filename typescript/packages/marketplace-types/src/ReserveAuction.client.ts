...
export class ReserveAuctionQueryClient
  implements ReserveAuctionReadOnlyInterface
{
...
export interface ReserveAuctionInterface
...
export class ReserveAuctionClient
  extends ReserveAuctionQueryClient
  implements ReserveAuctionInterface
{
